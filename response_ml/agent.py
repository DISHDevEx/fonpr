from .advisors import prom_client
...
prom_client_advisor = prom_client()
prom_client_advisor.set_queries(prom_cpu_mem_queries)
max_cpu_data,avg_cpu_data,max_memory_query,avg_memory_query =  prom_client_advisor.run_queries()
