...
class FONPR_Env(gym.Env):
    ...
    def _get_obs(self):
        ...
        prom_client_advisor.set_queries_by_function()
    ...
    def step(self, action):
        ...
        rxtx_value = 3.33e-9 # Roughly equivalent to dollars per bit over the network
        li_cost = get_infra_cost("Large") # Cost of large instance in dollars per hour
        si_cost = get_infra_cost("Small") # Cost of small instance in dollars per hour
