...
'''how cpu queries works: 
 (1)rate(container_cpu_usage_seconds_total[5m])[3h:]  returns the cpu cores total for 2 minute windows for the last 3 hours
    (a) by taking the rate of increase of container_cpu_usage_seconds_total we get the number of CPU-seconds consumed per second.
       ...
       ex/ rate(container_cpu_usage_seconds_total[10m]) is 1.34. This means our container spent an avg of 1.34 CPU seconds per specific seconds. (https://github.com/google/cadvisor/issues/2026)
