...
class FONPR_Env(Env):
    ...
    def __init__(self, env_config={'render_mode':None, 'window':15, 'sample_rate':4, 'obs_period':5}):
        ...
        self.step_counter = 0
        self.larg_instance_type = 'm4.xlarge' # Hardcoded to begin
    ...
    def _get_obs(self):
        ...
        df = pd.DataFrame(columns=['DateTime', 'Throughput', self.larg_instance_type, self.small_instance_type])
    ...
    def step(self, action):
        ...
        li_cost = ec2_cost_calculator(self.larg_instance_type) # Cost of large instance in dollars per hour
